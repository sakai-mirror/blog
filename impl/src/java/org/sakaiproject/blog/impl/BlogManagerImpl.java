    	...
    	return new HttpAccess()
    	{
			public void handleAccess(HttpServletRequest arg0, HttpServletResponse arg1, Reference arg2, Collection arg3) throws EntityPermissionException, EntityNotDefinedException, EntityAccessOverloadException, EntityCopyrightException
			{
				try
				{
					...
					String url = "http://btc224000006.lancs.ac.uk/portal/tool/fe1ba6dd-c67f-48b9-a4d4-9208ced4be9e/home?wicket:bookmarkablePage=%3Aorg.sakaiproject.blog.tool.pages.PostPage&postId=";
					url += referenceString.substring(referenceString.lastIndexOf(Entity.SEPARATOR));
