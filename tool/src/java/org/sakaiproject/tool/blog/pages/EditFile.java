	...
	public EditFile(Post post, int elementIndex,final boolean modify)
	{
		...
		saveButton = new Button("saveButton", new ResourceModel("save"))
		{
			public void onSubmit()
			{
				...
				if(!modify)
					EditFile.this.postManager.addElement(EditFile.this.post,file,EditFile.this.elementIndex);
				else
	                EditFile.this.postManager.replaceElement(EditFile.this.post,EditFile.this.file, EditFile.this.elementIndex);
