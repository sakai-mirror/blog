		...
		saveButton = new Button("saveButton", new ResourceModel("save"))
		{
			public void onSubmit()
			{
				if(modify)
					...
					EditText.this.postManager.replaceElement(EditText.this.post, text, EditText.this.elementIndex);
				else
					EditText.this.postManager.addElement(EditText.this.post,text,EditText.this.elementIndex);
